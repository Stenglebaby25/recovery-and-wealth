...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[hsl(200,15%,94%)] backdrop-blur-md border-b border-[hsl(200,10%,88%)] shadow-sm">
      <div className="container mx-auto px-4">
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-[hsl(200,10%,88%)] bg-[hsl(200,15%,95%)] backdrop-blur-md">
